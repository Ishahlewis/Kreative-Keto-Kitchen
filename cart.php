                         ...
                         <div class="my-cart"> 
                            ...
                            <div class="pages">
                             ...
                             <div class="checkout two">
                                    ...
                                    <form action="#" id="validForm" class="form2">
                                ...
                                <div class="checkout radio shipping-resp">
                                        ...
                                        <div class="choose">
                                            <div class="delivery" data-choice="delivery "><i class="fas fa-truck"></i></div>
                                            <div class="pick" data-choice="pick-up"><i class="fas fa-store"></i></div>
                                        </div>
                                ...
                                <div class="checkout four">
                                    <div class="head">
                                        <button><i class="fas fa-arrow-circle-left prev four"></i></button>
                                        <h2 class="h2-head">Payment</h2>    
                                    </div>       
                                    <div class="pay">
                                        <h4>Payment method</h4>   
                                        <h6>Internet Bank Transfer - Please pay to 020152 - 0046534 - 83</h6>
                                        <p>Please use your name as a reference when paying and notify me when the payment has been made in order for me to commence baking. While it is not neccessary, a screen shot of the payment is helpful.</p>
                                        <p>
                                    </div>
